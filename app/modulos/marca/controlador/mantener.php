...
include_once dirname(__DIR__) . '/modelo/Marca.inc.php';
include_once dirname(__DIR__) . '/modelo/MarcaDaoFactory.inc.php';
include_once dirname(__DIR__) . '/modelo/MarcaValidador.inc.php';
...
define('MODULO', 'marca');
define('RUTA_ADMINISTRAR', RUTA_ADMINISTRAR_MARCA);
define('RUTA_MANTENER', RUTA_MANTENER_MARCA);
