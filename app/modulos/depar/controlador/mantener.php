...
include_once dirname(__DIR__) . '/modelo/Depar.inc.php';
include_once dirname(__DIR__) . '/modelo/DeparDaoFactory.inc.php';
include_once dirname(__DIR__) . '/modelo/DeparValidador.inc.php';
...
define('MODULO', 'depar');
define('RUTA_ADMINISTRAR', RUTA_ADMINISTRAR_DEPAR);
define('RUTA_MANTENER', RUTA_MANTENER_DEPAR);
