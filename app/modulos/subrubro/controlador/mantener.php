...
include_once dirname(__DIR__) . '/modelo/Subrubro.inc.php';
include_once dirname(__DIR__) . '/modelo/SubrubroDaoFactory.inc.php';
include_once dirname(__DIR__) . '/modelo/SubrubroValidador.inc.php';
...
define('MODULO', 'subrubro');
define('RUTA_ADMINISTRAR', RUTA_ADMINISTRAR_SUBRUBRO);
define('RUTA_MANTENER', RUTA_MANTENER_SUBRUBRO);
