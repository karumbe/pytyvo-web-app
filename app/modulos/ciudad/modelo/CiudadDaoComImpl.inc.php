...
class CiudadDaoComImpl extends DaoBaseComImpl {
    ...
    */
    # @Override
    public function nombre_existe($nombre, $departamen = 0) {
        ...
        try {
            ...
            if (isset($this->conexion)) {
                $existe = $this->conexion->NombreExiste($nombre, $departamen);
            }
        } catch (Exception $ex) {
    ...
    */
    # @Override
    public function obtener_por_nombre($nombre, $departamen = 0) {
        # inicio { validaciones de parámetros }
        if (!$this->validar_param_nombre($nombre)) {
            return null;
        }
