...
include_once dirname(__DIR__) . '/modelo/MotivoNo.inc.php';
include_once dirname(__DIR__) . '/modelo/MotivoNoDaoFactory.inc.php';
include_once dirname(__DIR__) . '/modelo/MotivoNoValidador.inc.php';
...
$modulo = 'Motivo de las notas de déb./créd.';

define('MODULO', 'maquina');
define('RUTA_ADMINISTRAR', RUTA_ADMINISTRAR_MOTIVO_NO);
define('RUTA_MANTENER', RUTA_MANTENER_MOTIVO_NO);
