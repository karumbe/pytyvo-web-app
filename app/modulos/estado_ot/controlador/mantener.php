...
include_once dirname(__DIR__) . '/modelo/EstadoOt.inc.php';
include_once dirname(__DIR__) . '/modelo/EstadoOtDaoFactory.inc.php';
include_once dirname(__DIR__) . '/modelo/EstadoOtValidador.inc.php';
...
$modulo = 'Estado de la OT';

define('MODULO', 'estado_ot');
define('RUTA_ADMINISTRAR', RUTA_ADMINISTRAR_ESTADO_OT);
define('RUTA_MANTENER', RUTA_MANTENER_ESTADO_OT);
