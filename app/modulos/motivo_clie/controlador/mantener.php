...
include_once dirname(__DIR__) . '/modelo/MotivoClie.inc.php';
include_once dirname(__DIR__) . '/modelo/MotivoClieDaoFactory.inc.php';
include_once dirname(__DIR__) . '/modelo/MotivoClieValidador.inc.php';
...
$modulo = 'Motivo de ser cliente';

define('MODULO', 'motivo_clie');
define('RUTA_ADMINISTRAR', RUTA_ADMINISTRAR_MOTIVO_CLIE);
define('RUTA_MANTENER', RUTA_MANTENER_MOTIVO_CLIE);
